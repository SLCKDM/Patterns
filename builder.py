'''
Строитель - это пораждающий паттерн проектирования, который позволяет создавать
объекты пошагово.

В отличие от других пораждающих паттернов, Строитель позволяеть прозиводить
...
someBuilde.setValue(1).setValue(2).create())
'''
...
class ConcreteBuilder1(Builder):
    ...
    def product(self) -> Product1:
        ...
        Строителя (по кранйней мере, в статически типизированном языке
        программирования)
...
class Product1():
    ...
    достаточно сложно и требуют обширной конфигурации.

    В отличие от других порождающих паттернов, различные конкретные строители
    могут прозводить несвязанные продукты. Другими словами, результаты
    различных строителей могут не всегда следолвать одному и тому же интерфейсу.
    '''
    def __init__(self) -> None:
        self.parts = []
...
class Director:
    '''
    Директор отвечает только за выполнени шагов построения в определеннрй
    последовательности. Это полезно при производстве продкутов в определенном
